...
const systems = [
  ['core language', 'Lexical scope, closures, classes, lists, maps, modules, and clear failures.', '✓'],
  ['engine.graphics', 'Windows, sprites, shapes, text, cameras, render targets, and shaders.', '▧'],
  ['engine.input', 'Keyboard, pointer, controllers, remappable actions, and event state.', '⌁'],
  ['engine.audio', 'Sounds, streaming music, groups, fades, and positional playback.', '♫'],
  ['engine.physics', 'Bodies, shapes, layers, collision queries, and deterministic stepping.', '◉'],
  ['assets + storage', 'Packaged read-only assets and safe per-game save data.', '⌑'],
  ['host adapters', 'Raylib, SDL, browser, headless tests, and hosts built by the community.', '↝'],
  ['tooling', 'Editor, debugger, formatter, packages, and one-command builds.', '</>']
]
